...
CREATE INDEX `IX_StateProvince_CountryId` ON `StateProvince` (`CountryId`, `DisplayOrder`);
...
CREATE INDEX `IX_PSAM_AllowFiltering` ON `Product_SpecificationAttribute_Mapping` (`AllowFiltering` ASC, `ProductId`,`SpecificationAttributeOptionId`);

CREATE INDEX `IX_PSAM_SpecificationAttributeOptionId_AllowFiltering` ON `Product_SpecificationAttribute_Mapping` (`SpecificationAttributeOptionId` ASC, `AllowFiltering` ASC, `ProductId`);
